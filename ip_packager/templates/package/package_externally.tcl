...
set root_dir    [file normalize [file join $src_dir ".." "<EXTERNAL_FOOT_DIR>"]];   # IPI root directory.
...
ip_packager::archive_package_project    -output_path    "<your_output_path>"
